...
D_list = [10, 20, 30, 40, 50, 70]
N_jobs_list = [20, 30, 40, 50]

# D = 70
# B_avg = 1

# network = gen_network(noD=D, var=var, B_avg=B_avg, PS_avg=PS_avg)
# print("The edges of network ", network.number_of_edges())
# # for D in D_list:
# # 	network = gen_network(noD=D, var=var, B_avg=B_avg, PS_avg=PS_avg)
# # 	print("The edges of network ", network.number_of_edges())
...
# 	et = time.time()
# 	print("Assign tasks consume", et - st)
# 	if job_assigned:
...
for N_jobs in N_jobs_list:
	for B_avg in bw_list:
		for D in D_list:
			...
			print("The edges of network ", network_origin.number_of_edges())
